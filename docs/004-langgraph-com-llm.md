...
seja, o LangGraph não será só "um chat wrapper", agora ele passa
...
manualmente, certo? Ou seja, toda vez que o usuário enviar uma mensagem, eu preciso pegar as mensagens anteriores, adicionar a nova mensagem, enviar para o grafo, pegar a resposta e atualizar o estado.
